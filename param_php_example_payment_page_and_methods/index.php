<?php
session_start();
function calculateRatio($oran){
    return @number_format($_POST['tutar'] + ($_POST['tutar'] / 100 * floatval($oran)), 2, ',', '.');
}
            ...
            <div id="tl-field">
                <div class="col-xs-12 col-md-12 col-lg-12">
                    ...
                    <table class="table table-hover">
                        ...
                        <?php foreach ($ratioList->DT_Ozel_Oranlar as $key => $obj): ?>
                            ...
                            <?php endif; ?>
                        <?php endforeach; ?>
                        <?php foreach ($ratioListXml->DT_Ozel_Oranlar_SK as $key => $obj): ?>
                            <?php if ($obj->Kredi_Karti_Banka == 'Param'): ?>
