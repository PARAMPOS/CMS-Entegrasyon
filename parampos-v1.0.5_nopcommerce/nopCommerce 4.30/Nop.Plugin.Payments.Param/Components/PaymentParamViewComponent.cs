...
namespace Nop.Plugin.Payments.Param.Components
{
    ...
    {
        private readonly IParamPaymentSettings _eWayPaymentSettings;
        private readonly IShoppingCartModelFactory _shoppingCartService;
        private readonly IWorkContext _workContext;

        public PaymentParamViewComponent(IParamPaymentSettings eWayPaymentSettings, 
        ...
        public dynamic TP_Ozel_Oran_Liste()
        {
            //https://localhost:44369/ParamPos/TP_Ozel_Oran_Liste
            //https://localhost:44369/Admin/ParamPos/TP_Ozel_Oran_Liste
            string url = _eWayPaymentSettings.UseSandbox ? _eWayPaymentSettings.TestUrl : _eWayPaymentSettings.ProductUrl;
            string clientCode = _eWayPaymentSettings.ClientCode;
            string clientUsername = _eWayPaymentSettings.ClientUsername;
            string clientPassword = _eWayPaymentSettings.ClientPassword;
            string guidCode = _eWayPaymentSettings.Guid;
            bool installment = _eWayPaymentSettings.Installment;
