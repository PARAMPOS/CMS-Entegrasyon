...
class Parampos extends PaymentModule
{
    ...
    public function install()
    {
        ...
        if (_PS_VERSION_ >= '1.6' && (!$this->registerHook('paymentOptions'))) {
            $this->_errors[] = $this->l('There was an Error installing the module.');
            return false;
        }
...
//        return $this->display('module:parampos/views/templates/front/payment_form.tpl');
